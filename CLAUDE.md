...
| 3 | Arquitectura y patrones: foco principal en **Arquitectura Limpia/hexagonal** (capas, independencia de framework/DB, la que más se usa en APIs reales) — Diego la introduce al ver cómo un cambio de DB no debería tocar la lógica de negocio; monolito modular vs. microservicios, colas y eventos, cache, otros patrones de diseño quedan como contexto secundario. Decisión eje: monolito o microservicios con 3 desarrolladores | Pendiente |
